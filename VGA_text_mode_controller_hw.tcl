...
# Thu Dec 08 16:04:26 CST 2022
# DO NOT MODIFY


# 
# VGA_text_mode_controller "VGA_text_mode_controller" v1.0
# Zuofu Cheng 2022.12.08.16:04:26
# 
# 
...
add_fileset_file vga_text_avl_interface.sv SYSTEM_VERILOG PATH final_project_files/vga_text_avl_interface.sv TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file vga_text_avl_interface.sv SYSTEM_VERILOG PATH final_project_files/vga_text_avl_interface.sv
...
add_interface_port avl_mm_slave AVL_ADDR address Input 5
add_interface_port avl_mm_slave AVL_CS chipselect Input 1
add_interface_port avl_mm_slave AVL_READ read Input 1
add_interface_port avl_mm_slave AVL_READDATA readdata Output 16
add_interface_port avl_mm_slave AVL_WRITE write Input 1
add_interface_port avl_mm_slave AVL_WRITEDATA writedata Input 16
